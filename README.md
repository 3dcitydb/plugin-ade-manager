...
Latest release
--------------
The latest stable release of the ADE Manager Plugin is 2.1.0.

Download the software [here](https://github.com/3dcitydb/plugin-ade-manager/releases/download/v2.1.0/plugin-ade-manager-2.1.0.zip).
